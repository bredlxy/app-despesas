...
class RelatorioDespesasScreen extends StatefulWidget {
  const RelatorioDespesasScreen({super.key});

  @override
  RelatorioDespesasScreenState createState() => RelatorioDespesasScreenState();
}

class RelatorioDespesasScreenState extends State<RelatorioDespesasScreen> {
  List<Map<String, dynamic>> setembroExpenses = [
    ...
    {'title': 'Conta de água', 'category': 'Moradia', 'value': 76.48, 'imagePath': 'assets/imagens/moradia2.png'},
    {'title': 'Gasolina', 'category': 'Transporte', 'value': 248.50, 'imagePath': 'assets/imagens/transporte2.png'},
  ];

  List<Map<String, dynamic>> agostoExpenses = [
    {'title': 'Netflix', 'category': 'Assinaturas', 'value': 44.90, 'imagePath': 'assets/imagens/assinaturas1.png'},
    {'title': 'Conta de água', 'category': 'Moradia', 'value': 72.28, 'imagePath': 'assets/imagens/moradia2.png'},
    {'title': 'Gasolina', 'category': 'Transporte', 'value': 245.50, 'imagePath': 'assets/imagens/transporte2.png'},
  ];
